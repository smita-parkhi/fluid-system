        ...
        <div>
            <div className='container-wrapper'>
                ...
                <div className='right-section'>
                    ...
                    <p className='img-title'>Government of India has awarded the <b>"National Energy Conservation Award 2018".</b> Mr. G. Selvaraj, Joint Managing Director of C.R.I. Group received the award from Smt. Sumitra Mahajan, Speaker of Lok Sabha & Shri. Raj Kumar Singh, Honorable Minister of State.</p>
                </div>
            </div>
            ...
            <div className='equipment-section'>
                ...
                />
                <p className='img-title'>Valves - Pumps - Pipes - IoT Drives & Controllers - Wires & Cables - Solar Systems - Motors </p>
            </div>
